...
Premier tiene dos bases; Twin Suns permite tres o cuatro. Al escribir dos caracteres en el nombre, cada asiento muestra sugerencias de perfiles visibles con su avatar. Se puede seleccionar con toque o teclado y seguir usando un nombre libre para invitados; la selección no inicia la mesa ni vincula estadísticas. Cada jugador puede buscar su carta de base por nombre, subtítulo o expansión. La selección carga nombre, imagen y vida impresa; la vida inicial queda protegida mientras haya una carta elegida. **Usar vida manual** permite volver al ajuste libre (30 por defecto, entero de 1 a 999). La ilustración aparece de fondo y se puede ver la carta completa al tocar el contador. Pantalla dividida, modo frente a frente, ajustes de 1/5 y entrada de cantidades exactas. En paneles con poca altura los saltos de 5 quedan en el ajuste exacto para conservar botones accesibles. Mantener ± pulsado comienza a repetir a los 350ms y continúa cada 140ms; se detiene al soltar, salir del botón o cancelar. Un toque cuenta una sola vez, con límites de vida y Deshacer. La mesa evita selección de texto sin bloquear los campos editables.
...
Números de siete segmentos en SVG, anillos orbitales, encendido escalonado, partículas y ondas ante daño, pulso de curación y fichas iluminadas. Sonido sintetizado opcional, apagado por defecto. El daño combina golpe y armónicos, la curación asciende; Ajustes ofrece volumen 0–100 (80 por defecto), prueba de sonido y guardado de preferencia. Se respeta movimiento reducido, hay interruptor de efectos y las animaciones se pausan al ocultar la pestaña. Wake Lock y Fullscreen se usan cuando están disponibles; la vista ocupa `100dvh` aunque el navegador no admita Fullscreen.

...
import { PuertaInstalacion } from '../../features/pwa/PuertaInstalacion'
...
export function AppLayout() {
  ...
  return (
    // La puerta envuelve el CAPARAZÓN ENTERO y no solo el <main>: si tapara
    // únicamente el contenido, el Header y la TabBar seguirían visibles y
    // clicables por debajo, y —lo que de verdad importa— las pantallas de
    // adentro se montarían igual y saldrían a consultar la nube.
    <PuertaInstalacion>

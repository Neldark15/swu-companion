...
export const DAILY_MISSIONS: MissionTemplate[] = [
  ...
  { id: 'd_trivia1',   type: 'daily', dificultad: 'toque', ruta: '/trivia',     donde: 'Trivia',    name: 'Archivos Jedi',         description: 'Contestar 1 pregunta de la trivia',         objectiveType: 'trivia_respondida',   objectiveValue: 1, rewardXp: 15, icon: '🧠' },
  ...
  { id: 'd_trivia3',   type: 'daily', dificultad: 'toque', ruta: '/trivia',     donde: 'Trivia',    name: 'Buena memoria',  description: 'Contestar 3 preguntas de la trivia',        objectiveType: 'trivia_respondida',   objectiveValue: 3, rewardXp: 25, icon: '📚' },
...
export const UNIQUE_MISSIONS: MissionTemplate[] = [
  ...
  { id: 'u_trivia1',    type: 'unique', dificultad: 'toque', ruta: '/trivia',    donde: 'Trivia',     name: 'Primer archivo',     description: 'Contestá una pregunta de la trivia', objectiveType: 'trivia_respondida', objectiveValue: 1,  rewardXp: 50,  icon: '🧠' },
  ...
  { id: 'u_trivia50',   type: 'unique', dificultad: 'toque', ruta: '/trivia',    donde: 'Trivia',     name: 'Bibliotecario',      description: 'Contestá 50 preguntas de la trivia', objectiveType: 'trivia_respondida', objectiveValue: 50, rewardXp: 250, icon: '📚' },
...
export const WEEKLY_MISSIONS: MissionTemplate[] = [
  ...
  { id: 'w_trivia10',  type: 'weekly', dificultad: 'toque', ruta: '/trivia',    donde: 'Trivia',    name: 'Archivos completos',  description: 'Contestar 10 preguntas de la trivia', objectiveType: 'trivia_respondida',   objectiveValue: 10, rewardXp: 55, icon: '🧠' },

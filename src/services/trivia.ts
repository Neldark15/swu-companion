...
export const TRIVIA_QUESTIONS: TriviaQuestion[] = [
  ...
  { id: 's21', question: '¿Qué rango tiene un jugador de nivel 1-5 en HOLOCRON SWU?', options: ['Padawan', 'Youngling', 'Iniciado', 'Aprendiz'], correctIndex: 1, category: 'swu', funFact: 'Youngling es el primer rango, inspirado en los jóvenes aprendices del Templo Jedi.' },
